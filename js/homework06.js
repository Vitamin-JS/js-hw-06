...
// МЕТОД МАССИВА   map
// Получи массив имен всех пользователей(свойство name), используя деструктурирующее присваивание ДП для параметра функции({ name })
...
// Т.е.нельзя использовать ========sort, for, splice, push ============ и т.п.мутирующие методы.

// ПРИМЕР - Деструктурирующее присваивание для параметра функции
...
// const getUserNames = (array) => array.map(({ name }) => name); // ------- OK  user.name === {name}
...
//   array.filter((element, { eyeColor }) => eyeColor === color);
...
// =====================================================================================================
//
// --------МЕТОД    filter, map И СОЗДАНИЕ АНОНИМНЫХ ОБЪЕКТОВ
...
// =====================================================================================================
//
// -----------------------------МЕТОД        filter, includes и map
// Получи массив имен всех пользователей у которых есть друг с заданным именем.

// Используй деструктурирующее присваивание для параметра функции { friends } и({ name }) без
...
//
// Write code under this line
// const getUsersWithFriend = (array, friendName) => array;   ------ Задание
...
// Write code under this line
// const getNamesSortedByFriendsCount = (array) => array; -------- Задание
...
// const getSortedUniqueSkills = (array) => [...array].reduce((acc, { skills }) => [...acc, ...skills], []).filter((skills, index, array) => array.indexOf(skills) === index).sort();
